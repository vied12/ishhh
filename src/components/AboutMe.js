...
const AboutMe = ({ classes }) => (
  <div>
    ...
    <p className="follow-us">
      <Button href="https://www.instagram.com/carmenspella/" target="_blank" rel="nofollow noreferrer">
        <Fontawesome name="instagram" size="2x" className={classes.icon} />
        carmenspella
      </Button>
      <Button href="https://www.facebook.com/Ishhhliebedich/" target="_blank" rel="nofollow noreferrer">
        <Fontawesome name="facebook-official" size="2x" className={classes.icon} />
        Ishhhliebedich
      </Button>
    </p>
  </div>
